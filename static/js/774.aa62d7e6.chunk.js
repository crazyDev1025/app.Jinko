    ...
    7171: function (e, t, n) {
          ...
          var e =
            ...
            o =
              arguments.length > 3 && void 0 !== arguments[3]
                ? arguments[3]
                : function (e) {
                    return e.configurable && e.enumerable && e.writable;
                  },
            a =
                ...
                : function (a) {
                    ...
                    var p = m[0],
                      ...
                      W = function (e) {
                        var t,
                          n = O.get(e);
                        n && (O.delete(e), null == (t = n[1]) || t.call(n));
                      },
                      k = Array.isArray(a)
                        ? []
                        : Object.create(Object.getPrototypeOf(a)),
                      E = function (t, r, o, a, i) {
                        if (!t || !(e(r, a) || (f.has(a) && e(r, f.get(a))))) {
                          W(o),
                            v(a) &&
                              (a =
                                (function (e) {
                          ...
                          if (a instanceof Promise)
                            ...
                            !h.has(a) && n(a) && (s = g(a));
                            var c = !b.has(s) && h.get(s);
                            c &&
                              (function (e, t) {
                                if (O.has(e))
                                  throw new Error(
                                    "prop listener already exists"
                                  );
                                if (y.size) {
                                  var n = t[3](C(e));
                                  O.set(e, [t, n]);
                      ...
                      j = t(k, {
                        deleteProperty: function (e, t) {
                          ...
                          return r && w(["delete", [t], n]), r;
                        },
                        set: function (e, t, n, r) {
                          var o = Reflect.has(e, t),
                            a = Reflect.get(e, t, r);
                          return (
                            E(o, a, t, n, function (n) {
                              Reflect.set(e, t, n, r);
                            }),
                            !0
                          );
                    ...
                    return (
                      ...
                      Reflect.ownKeys(a).forEach(function (e) {
                        ...
                        "value" in t &&
                          ((j[e] = a[e]), delete t.value, delete t.writable),
                          Object.defineProperty(k, e, t);
                      }),
                      j
                    );
                  };
          return [g, h, b, e, t, n, o, a, i, l, f, m];
        },
        g = m(),
        y = (0, s.Z)(g, 1)[0];
      function w() {
      ...
      var C = w({
        ...
        O = {
          ...
          push: function (e, t) {
            e !== C.view &&
              ((C.view = e), t && (C.data = t), C.history.push(e));
          },
          reset: function (e) {
          ...
          replace: function (e) {
            C.history.length > 1 &&
              ((C.history[C.history.length - 1] = e), (C.view = e));
          },
          goBack: function () {
            if (C.history.length > 1) {
              C.history.pop();
              var e = C.history.slice(-1),
                t = (0, s.Z)(e, 1)[0];
              C.view = t;
            }
          },
        ...
        W = {
            ...
            return (
              ...
              Boolean(
                window.matchMedia("(pointer:coarse)").matches ||
                  /Android|webOS|iPhone|iPad|iPod|BlackBerry|Opera Mini/.test(
                    navigator.userAgent
                  )
              )
            );
          ...
          formatNativeUrl: function (e, t, n) {
            if (W.isHttpUrl(e)) return this.formatUniversalUrl(e, t, n);
            var r = e;
            r.includes("://") ||
            ...
            return "".concat(r, "wc?uri=").concat(o);
          },
          formatUniversalUrl: function (e, t, n) {
            if (!W.isHttpUrl(e)) return this.formatNativeUrl(e, t, n);
            var r = e;
            r.endsWith("/") || (r = "".concat(r, "/")),
              this.setWalletConnectDeepLink(r, n);
            var o = encodeURIComponent(t);
          ...
          setModalVersionInStorage: function () {
            try {
              typeof localStorage < "u" &&
                localStorage.setItem(W.WCM_VERSION, "2.6.1");
            } catch (e) {
          ...
          getWalletRouterData: function () {
            var e,
              t = null == (e = O.state.data) ? void 0 : e.Wallet;
        ...
        E = {
          ...
          initialize: function () {
            k.enabled &&
              ...
              (k.userSessionId = crypto.randomUUID());
          },
          setConnectedWalletId: function (e) {
            k.connectedWalletId = e;
          },
          click: function (e) {
            if (k.enabled) {
              var t = {
        ...
        x = {
          ...
          setWalletConnectUri: function (e) {
        ...
        L = {
          ...
          setConfig: function (e) {
            var t, n;
            E.initialize(),
              x.setChains(e.chains),
              x.setIsAuth(Boolean(e.enableAuthMode)),
              x.setIsCustomMobile(
                Boolean(null == (t = e.mobileWallets) ? void 0 : t.length)
              ),
              x.setIsCustomDesktop(
                Boolean(null == (n = e.desktopWallets) ? void 0 : n.length)
              ),
              W.setModalVersionInStorage(),
              Object.assign(A, e);
          },
        },
              ...
              return (0, a.Z)().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (r = S({ sdkType: R, sdkVersion: T }, n)),
                        (o = new URL(t, N)).searchParams.append(
                          "projectId",
                          L.state.projectId
                        ),
                        Object.entries(r).forEach(function (e) {
                          var t = (0, s.Z)(e, 2),
                            n = t[0],
                            r = t[1];
                          r && o.searchParams.append(n, String(r));
                        }),
                        (e.next = 5),
                        fetch(o)
                      );
      ...
      var z = function (e) {
            ...
            (0, a.Z)().mark(function t() {
              return (0, a.Z)().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return t.abrupt("return", _("/w3m/v1/getAllListings", e));
                    case 1:
                    case "end":
                      return t.stop();
                  }
        ...
        K = function (e) {
          return ""
            .concat(N, "/w3m/v1/getWalletImage/")
            .concat(e, "?projectId=")
            .concat(L.state.projectId, "&sdkType=")
            .concat(R, "&sdkVersion=")
            .concat(T);
        },
        J = function (e) {
          return ""
            .concat(N, "/w3m/v1/getAssetImage/")
            .concat(e, "?projectId=")
            .concat(L.state.projectId, "&sdkType=")
            .concat(R, "&sdkVersion=")
            .concat(T);
          ...
          getRecomendedWallets: function () {
            return (0, i.Z)(
              (0, a.Z)().mark(function e() {
                var t, n, r, o, i, s, c, u, l, f, d, p, v, h, b;
                return (0, a.Z)().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return e.abrupt("return", ee.recomendedWallets);
                      case 3:
                        if (!W.isArray(n)) {
                          e.next = 13;
                          break;
                      ...
                      case 13:
                        ...
                        return (e.next = 22), B(v);
                      case 22:
                        (e.t0 = e.sent), (e.next = 28);
                        break;
                      case 25:
                        return (e.next = 27), z(v);
                      case 27:
                        e.t0 = e.sent;
                      case 28:
                        (h = e.t0),
                          (b = h.listings),
                          (ee.recomendedWallets = Object.values(b));
                      case 31:
                        return e.abrupt("return", ee.recomendedWallets);
                      case 32:
                      case "end":
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          ((n = Y({}, e)),
                          (o = L.state),
                          (i = o.explorerRecommendedWalletIds),
                          (s = o.explorerExcludedWalletIds),
                        ...
                        return t.abrupt("return", ee.wallets);
                      case 3:
                        if (
                          (c.length
                            ? (n.excludedIds = c
                                ...
                                .join(","))
                            : W.isArray(i) && (n.excludedIds = i.join(",")),
                          W.isArray(s) &&
                            (n.excludedIds = [n.excludedIds, s]
                              .filter(Boolean)
                              .join(",")),
                          x.state.isAuth && (n.sdks = "auth_v1"),
                          (u = e.page),
                          (l = e.search),
                          !$)
                        ) {
                      ...
                      case 15:
                        return (
                          ...
                          t.abrupt(
                            "return",
                            ((ee[h] = {
                              listings: [].concat((0, r.Z)(ee[h].listings), v),
                              total: p,
                        ...
                        return t.abrupt(
                          ...
                          new Promise(function (t) {
                            var n = x.state,
                              ...
                              o = n.isDataLoaded;
                            if (
                              (W.removeWalletConnectDeepLink(),
                              x.setWalletConnectUri(
                                null === e || void 0 === e ? void 0 : e.uri
                              ),
                              x.setChains(
                                null === e || void 0 === e ? void 0 : e.chains
                              ),
                              O.reset("ConnectWallet"),
                              r && o)
                            )
                              (ne.open = !0), t();
                            else
      ...
      var ue = w({
        ...
        le = {
          ...
          setThemeConfig: function (e) {
            ...
            t && (ue.themeMode = t),
              n &&
                (ue.themeVariables = (function (e, t) {
                  for (var n in t || (t = {})) ie.call(t, n) && ce(e, n, t[n]);
                  if (ae) {
                    var r,
                      a = (0, o.Z)(ae(t));
                    try {
                      for (a.s(); !(r = a.n()).done; )
                        (n = r.value), se.call(t, n) && ce(e, n, t[n]);
                    } catch (i) {
                      a.e(i);
                    } finally {
                      a.f();
        ...
        fe = w({ open: !1, message: "", variant: "success" }),
        de = {
          state: fe,
          subscribe: function (e) {
            return I(fe, function () {
              return e(fe);
            });
          },
          openToast: function (e, t) {
            (fe.open = !0), (fe.message = e), (fe.variant = t);
          },
          closeToast: function () {
            fe.open = !1;
          },
        ...
        c = (function () {
          function e(t) {
            (0, a.Z)(this, e),
              ...
              (this.setTheme = s.Ic.setThemeConfig),
              s.Ic.setThemeConfig(t),
              s.t0.setConfig(t),
              this.initUi();
          }
          return (
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              ...
                              return (
                                (e.next = 3), n.e(3459).then(n.bind(n, 3459))
                              );
                            case 3:
                              (t = document.createElement("wcm-modal")),
...
//# sourceMappingURL=774.aa62d7e6.chunk.js.map
