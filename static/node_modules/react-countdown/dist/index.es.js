...
function zeroPad(value) {
  ...
  var paddedNo =
    strNo.length >= length
      ? strNo
      : (
          _toConsumableArray(Array(length))
            .map(function () {
              return "0";
            })
            .join("") + strNo
...
function formatTimeDelta(timeDelta, options) {
  ...
  var _Object$assign = Object.assign(
      Object.assign({}, timeDeltaFormatOptionsDefaults),
      options
    ),
    ...
    zeroPadDays =
      _Object$assign$zeroPa === void 0 ? zeroPadTime : _Object$assign$zeroPa;

  var zeroPadTimeLength = Math.min(2, zeroPadTime);
  var formattedHours = daysInHours
...
var Countdown$1 = (function (_React$Component) {
  ...
  function Countdown$1(props) {
    ...
    _this.offsetStartTimestamp = _this.props.autoStart
      ? 0
      : _this.initialTimestamp;
    _this.offsetTime = 0;
    ...
    _this.tick = function () {
      ...
      var callback =
        timeDelta.completed && !_this.props.overtime
          ? undefined
          : _this.props.onTick;
    ...
    _this.start = function () {
      ...
      _this.offsetTime += prevOffsetStartTimestamp
        ? _this.calcOffsetStartTimestamp() - prevOffsetStartTimestamp
        : 0;
    ...
    _this.pause = function () {
      ...
      _this.setTimeDeltaState(
        _this.state.timeDelta,
        "PAUSED",
        _this.props.onPause
      );
    };
...
Countdown$1.defaultProps = Object.assign(
  Object.assign({}, timeDeltaFormatOptionsDefaults),
  {
    controlled: false,
    intervalDelay: 1000,
