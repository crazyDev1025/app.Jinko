...
const useFloatingParentNodeId = () => {
  ...
  return (
    ((_React$useContext = React.useContext(FloatingNodeContext)) == null
      ? void 0
...
function activeElement$1(doc) {
  ...
  while (
    ((_activeElement = activeElement) == null
      ? void 0
      : (_activeElement$shadow = _activeElement.shadowRoot) == null
      ? void 0
      : _activeElement$shadow.activeElement) != null
  ) {
...
function getTabbableIn(container, direction) {
  ...
  const activeIndex = allTabbable.indexOf(
    activeElement$1(getDocument(container))
  );
...
const FocusGuard = /*#__PURE__*/ React.forwardRef(function FocusGuard(
  props,
  ref
) {
...
const useFloatingPortalNode = function (_temp) {
  ...
  index(() => {
    ...
    if (rootNode) {
      ...
      const container =
        (portalContext == null ? void 0 : portalContext.portalNode) ||
        document.body;
...
const FloatingPortal = (_ref) => {
  ...
  React.useEffect(() => {
    if (
      !portalNode ||
      !preserveTabOrder ||
      (focusManagerState != null && focusManagerState.modal)
    ) {
      return;
    }
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    shouldRenderGuards &&
      portalNode &&
      /*#__PURE__*/ React.createElement(FocusGuard, {
        "data-type": "outside",
    ...
    root
      ? /*#__PURE__*/ createPortal(children, root)
      : portalNode
      ? /*#__PURE__*/ createPortal(children, portalNode)
      : null,
    shouldRenderGuards &&
      portalNode &&
      /*#__PURE__*/ React.createElement(FocusGuard, {
...
const VisuallyHiddenDismiss = /*#__PURE__*/ React.forwardRef(
  function VisuallyHiddenDismiss(props, ref) {
    return /*#__PURE__*/ React.createElement(
      "button",
      _extends({}, props, {
        type: "button",
...
function FloatingFocusManager(_ref) {
  ...
  const tree = useFloatingTree();
  const portalContext = usePortalContext();
  const [tabbableContentLength, setTabbableContentLength] =
    React.useState(null);
      ...
      const movedToUnrelatedNode = !(
        ...
        (tree &&
          (getChildren(tree.nodesRef.current, nodeId).find((node) => {
            ...
            return (
              contains(
                (_node$context = node.context) == null
                  ? void 0
  ...
  React.useEffect(() => {
    ...
    const portalNodes = Array.from(
      (portalContext == null
        ? void 0
        : (_portalContext$portal = portalContext.portalNode) == null
        ? void 0
  ...
  index(() => {
    ...
    return () => {
      events.off("dismiss", onDismiss);
      if (
        contains(floating, activeElement$1(doc)) &&
      ...
      if (
        ...
        if (!refs.domReference.current || isPointerDownRef.current) {
          ...
          // element.
          (_previouslyFocusedEle = previouslyFocusedElementRef.current) == null
            ? void 0
            : _previouslyFocusedEle.focus({
                preventScroll: preventReturnFocusScroll,
              });
          setTimeout(() => {
        ...
        onFocus: (event) => {
          if (modal) {
            ...
            if (isOutsideEvent(event, portalContext.portalNode)) {
              ...
              (_portalContext$afterO = portalContext.afterOutsideRef.current) ==
              null
                ? void 0
 ...
 */
const FloatingOverlay = /*#__PURE__*/ React.forwardRef(function FloatingOverlay(
  _ref,
  ref
) {
  ...
  index(() => {
    ...
    const offsetLeft =
      ((_window$visualViewpor = window.visualViewport) == null
        ? void 0
        : _window$visualViewpor.offsetLeft) || 0;
    const offsetTop =
      ((_window$visualViewpor2 = window.visualViewport) == null
        ? void 0
        : _window$visualViewpor2.offsetTop) || 0;
  ...
  return {
    escapeKeyBubbles:
      typeof bubbles === "boolean"
        ? bubbles
        : (_bubbles$escapeKey = bubbles.escapeKey) != null
        ? _bubbles$escapeKey
        : true,
    outsidePressBubbles:
      typeof bubbles === "boolean"
        ? bubbles
        : (_bubbles$outsidePress = bubbles.outsidePress) != null
        ? _bubbles$outsidePress
        : true,
  };
};
/**
  ...
  React.useEffect(() => {
    ...
    function onBlur() {
      if (
        ...
        domReference === activeElement$1(getDocument(domReference))
      ) {
      ...
      reference: {
        ...
        onFocus(event) {
          ...
          if (
            ...
            ((_dataRef$current$open = dataRef.current.openEvent) == null
              ? void 0
              : _dataRef$current$open.type) === "mousedown" &&
            dataRef.current.openEvent &&
...
function findNonDisabledIndex(listRef, _temp) {
  ...
  do {
    ...
    (disabledIndices
      ...
      : list[index] == null ||
        ((_list$index = list[index]) == null
          ? void 0
          : _list$index.hasAttribute("disabled")) ||
        ((_list$index2 = list[index]) == null
          ? void 0
          : _list$index2.getAttribute("aria-disabled")) === "true")
  );
  return index;
}
...
const useListNavigation = function (_ref, _temp2) {
  ...
  const focusItem = React.useCallback(
    function (listRef, indexRef, forceScrollIntoView) {
  ...
  index(() => {
    ...
    if (previousOpenRef.current && !open) {
      ...
      if (
        parentFloating &&
        !contains(parentFloating, activeElement$1(getDocument(parentFloating)))
      ) {
      ...
      ...(focusItemOnHover && {
        ...
        onPointerLeave() {
          ...
          if (!virtual) {
            ...
            (_refs$floating$curren = refs.floating.current) == null
              ? void 0
              : _refs$floating$curren.focus({
                  preventScroll: true,
                });
          }
        },
    ...
    function onKeyDown(event) {
      ...
      if (isMainOrientationKey(event.key, orientation)) {
        ...
        if (
          open &&
          !virtual &&
          activeElement$1(event.currentTarget.ownerDocument) ===
            event.currentTarget
        ) {
...
const useTypeahead = function (_ref, _temp) {
  ...
  const prevIndexRef = React.useRef(
    (_ref2 = selectedIndex != null ? selectedIndex : activeIndex) != null
      ? _ref2
      : -1
  );
  ...
  index(() => {
    ...
    if (open && stringRef.current === "") {
      ...
      prevIndexRef.current =
        (_ref3 = selectedIndex != null ? selectedIndex : activeIndex) != null
          ? _ref3
          : -1;
    }
  ...
  return React.useMemo(() => {
    ...
    function onKeyDown(event) {
      ...
      if (
        isElement(target) &&
        (activeElement$1(getDocument(target)) !== event.currentTarget
          ? (_refs$floating$curren = refs.floating.current) != null &&
            _refs$floating$curren.contains(target)
            ? target.closest(
      ...
      const allowRapidSuccessionOfFirstLetter = listContent.every((text) => {
        ...
        return text
          ? ((_text$ = text[0]) == null
              ? void 0
              : _text$.toLocaleLowerCase()) !==
              ((_text$2 = text[1]) == null
                ? void 0
                : _text$2.toLocaleLowerCase())
          : true;
      });
...
const useInnerOffset = (_ref, _ref2) => {
  ...
  React.useEffect(() => {
    ...
    const el =
      (scrollRef == null ? void 0 : scrollRef.current) || elements.floating;
    if (open && el) {
...
function safePolygon(_temp) {
  ...
  const fn = (_ref) => {
    ...
    return function onMouseMove(event) {
      ...
      if (
        tree &&
        getChildren(tree.nodesRef.current, nodeId).some((_ref2) => {
          let { context } = _ref2;
          ...
          if (key.indexOf("on") === 0) {
            ...
            if (typeof value === "function") {
              ...
              acc[key] = function () {
                ...
                (_map$get2 = map.get(key)) == null
                  ? void 0
                  : _map$get2.forEach((fn) => fn(...args));
              };
            }
          } else {
            acc[key] = value;
