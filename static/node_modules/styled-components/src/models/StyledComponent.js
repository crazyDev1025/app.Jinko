...
export default function createStyledComponent(
  ...
  const finalAttrs =
    isTargetStyledComp && ((target: any): IStyledComponent).attrs
      ? Array.prototype
          .concat(((target: any): IStyledComponent).attrs, attrs)
          .filter(Boolean)
      : attrs;
  ...
  if (isTargetStyledComp && target.shouldForwardProp) {
    if (options.shouldForwardProp) {
      ...
      shouldForwardProp = (prop, filterFn, elementToBeCreated) =>
        ((((target: any): IStyledComponent)
          .shouldForwardProp: any): ShouldForwardProp)(
          prop,
          filterFn,
          elementToBeCreated
        ) &&
        ((options.shouldForwardProp: any): ShouldForwardProp)(
          prop,
          filterFn,
          elementToBeCreated
        );
  ...
  const componentStyle = new ComponentStyle(
    ...
    styledComponentId,
    isTargetStyledComp
      ? ((target: Object).componentStyle: ComponentStyle)
      : undefined
  );
  ...
  if (isCompositeComponent) {
    ...
    >(
      ...
      ((target: any): $PropertyType<IStyledComponent, "target">),
      {
