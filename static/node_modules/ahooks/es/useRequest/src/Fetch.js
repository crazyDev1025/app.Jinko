...
var Fetch = /** @class */ (function () {
  ...
  Fetch.prototype.runPluginHandler = function (event) {
    ...
    var r = this.pluginImpls
      .map(function (i) {
        var _a;
        return (_a = i[event]) === null || _a === void 0
          ? void 0
          : _a.call.apply(_a, __spreadArray([i], __read(rest), false));
      })
      .filter(Boolean);
      ...
      return __generator(this, function (_q) {
        switch (_q.label) {
          case 0:
            ...
            (_l = this.runPluginHandler("onBefore", params)),
              (_m = _l.stopNow),
              (stopNow = _m === void 0 ? false : _m),
              (_o = _l.returnNow),
              (returnNow = _o === void 0 ? false : _o),
            ...
            (_b = (_a = this.options).onBefore) === null || _b === void 0
              ? void 0
              : _b.call(_a, params);
            _q.label = 1;
          case 1:
            ...
            if (!servicePromise) {
              servicePromise = (_p = this.serviceRef).current.apply(
                _p,
          ...
          case 2:
            ...
            (_d = (_c = this.options).onSuccess) === null || _d === void 0
              ? void 0
              : _d.call(_c, res, params);
            this.runPluginHandler("onSuccess", res, params);
            (_f = (_e = this.options).onFinally) === null || _f === void 0
              ? void 0
              : _f.call(_e, params, res, undefined);
            if (currentCount === this.count) {
          ...
          case 3:
            ...
            (_h = (_g = this.options).onError) === null || _h === void 0
              ? void 0
              : _h.call(_g, error_1, params);
            this.runPluginHandler("onError", error_1, params);
            (_k = (_j = this.options).onFinally) === null || _k === void 0
              ? void 0
              : _k.call(_j, params, undefined, error_1);
            if (currentCount === this.count) {
  ...
  Fetch.prototype.run = function () {
    ...
    this.runAsync
      .apply(this, __spreadArray([], __read(params), false))
  ...
  Fetch.prototype.refresh = function () {
    ...
    this.run.apply(
      this,
      __spreadArray([], __read(this.state.params || []), false)
    );
  };
