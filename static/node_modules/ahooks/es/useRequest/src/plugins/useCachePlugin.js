...
var useCachePlugin = function (fetchInstance, _a) {
  ...
  useCreation(function () {
    ...
    unSubscribeRef.current = cacheSubscribe.subscribe(
      cacheKey,
      function (data) {
  ...
  useUnmount(function () {
    var _a;
    (_a = unSubscribeRef.current) === null || _a === void 0
      ? void 0
      : _a.call(unSubscribeRef);
  });
  if (!cacheKey) {
    return {};
  }
    ...
    onBefore: function (params) {
      ...
      if (
        ...
        return {
          loading: false,
          data:
            cacheData === null || cacheData === void 0
              ? void 0
              : cacheData.data,
          error: undefined,
          returnNow: true,
