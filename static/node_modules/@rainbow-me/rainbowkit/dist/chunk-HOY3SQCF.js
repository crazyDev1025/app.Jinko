...
var normalizeResponsiveValue = _a49f6({
  conditions: {
    defaultCondition: "smallScreen",
    conditionNames: ["smallScreen", "largeScreen"],
    responsiveArray: void 0,
...
function useAuthenticationAdapter() {
  var _a;
  const { adapter } =
    (_a = useContext(AuthenticationContext)) != null ? _a : {};
  if (!adapter) {
...
function useAuthenticationStatus() {
  ...
  return (_a = contextValue == null ? void 0 : contextValue.status) != null
    ? _a
    : null;
}
...
// src/components/Icons/Spinner.tsx
var useRandomId = (prefix) =>
  useMemo2(() => `${prefix}_${Math.round(Math.random() * 1e9)}`, [prefix]);
...
var provideRainbowKitChains = (chains) =>
  chains.map((chain) => {
    var _a;
    return {
...
var useInitialChainId = () =>
  useContext3(RainbowKitChainContext).initialChainId;
...
import {
  useAccount as useAccount12,
  useBalance as useBalance2,
  useNetwork as useNetwork7,
} from "wagmi";
...
function useMainnet() {
  ...
  const enabled =
    chains == null
      ? void 0
      : chains.some((chain) => (chain == null ? void 0 : chain.id) === chainId);
...
function useChainId() {
  ...
  return (_a = activeChain == null ? void 0 : activeChain.id) != null
    ? _a
    : null;
}
...
function createTransactionStore({ provider: initialProvider }) {
  ...
  function getTransactions(account, chainId) {
    var _a, _b;
    return (_b = (_a = data[account]) == null ? void 0 : _a[chainId]) != null
      ? _b
      : [];
  }
  ...
  function updateTransactions(account, chainId, updateFn) {
    ...
    const transactions = updateFn(
      (_b = data[account][chainId]) != null ? _b : []
    ).filter(({ status }) => {
...
function getBrowser() {
  ...
  if ((_a = navigator.brave) == null ? void 0 : _a.isBrave)
    ...
    return "Edge" /* Edge */;
  else if (ua.indexOf("op") > -1) return "Opera" /* Opera */;
  else if (isArc()) return "Arc" /* Arc */;
  else if (ua.indexOf("chrome") > -1) return "Chrome" /* Chrome */;
...
var getExtensionDownloadUrl = (wallet) => {
  ...
  return (_l = {
    ["Arc" /* Arc */]:
      (_a = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _a.chrome,
    ["Brave" /* Brave */]:
      (_b = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _b.chrome,
    ["Chrome" /* Chrome */]:
      (_c = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _c.chrome,
    ["Edge" /* Edge */]:
      ((_d = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _d.edge) ||
      ((_e = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _e.chrome),
    ["Firefox" /* Firefox */]:
      (_f = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _f.firefox,
    ["Opera" /* Opera */]:
      ((_g = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _g.opera) ||
      ((_h = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _h.chrome),
    ["Safari" /* Safari */]:
      (_i = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _i.safari,
    ["Browser" /* Browser */]:
      (_j = wallet == null ? void 0 : wallet.downloadUrls) == null
        ? void 0
        : _j.browserExtension,
  }[browser]) != null
    ? _l
    : (_k = wallet == null ? void 0 : wallet.downloadUrls) == null
    ? void 0
    : _k.browserExtension;
};
...
function getRecentWalletIds() {
  return typeof localStorage !== "undefined"
    ? safeParseJsonArray(localStorage.getItem(storageKey2))
    : [];
}
    ...
    const result = await connectAsync({
      chainId:
        (_c =
          intialChainId != null
            ? intialChainId
            : (_a = rainbowKitChains.find(({ id }) => id === walletChainId)) ==
              null
            ? void 0
            : _a.id) != null
          ? _c
          : (_b = rainbowKitChains[0]) == null
          ? void 0
          : _b.id,
      connector,
    });
    ...
    walletConnectors.push({
      ...
      onConnecting: (fn) =>
        wallet.connector.on("message", ({ type }) =>
          type === "connecting" ? fn() : void 0
        ),
      ready:
        ((_a = wallet.installed) != null ? _a : true) && wallet.connector.ready,
      recent,
...
var AssetsIcon = () =>
  /* @__PURE__ */ React12.createElement(AsyncImage, {
    background: "#d0d5de",
    borderRadius: "10",
    height: "48",
    src,
...
var LoginIcon = () =>
  /* @__PURE__ */ React13.createElement(AsyncImage, {
    background: "#d0d5de",
    borderRadius: "10",
    height: "48",
    src: src2,
...
function FocusTrap(props) {
  ...
  useEffect9(() => {
    ...
    return () => {
      var _a;
      (_a = previouslyActiveElement.focus) == null
        ? void 0
        : _a.call(previouslyActiveElement);
    };
  }, []);
  useEffect9(() => {
        ...
        className: [
          wide
            ? mobile
              ...
              : compactModeEnabled
              ? dialogContentCompactMode
              : dialogContentWideDesktop
            : dialogContent,
...
var chainToExplorerUrl = (chain) => {
  var _a, _b;
  return (_b =
    (_a = chain == null ? void 0 : chain.blockExplorers) == null
      ? void 0
      : _a.default) == null
    ? void 0
    : _b.url;
    ...
    /* @__PURE__ */ React29.createElement(
      ...
      /* @__PURE__ */ React29.createElement(
        ...
        /* @__PURE__ */ React29.createElement(
          ...
          /* @__PURE__ */ React29.createElement(Icon, null)
        ),
        /* @__PURE__ */ React29.createElement(
          Box,
          {
  ...
  return /* @__PURE__ */ React30.createElement(
    ...
    /* @__PURE__ */ React30.createElement(
      ...
      /* @__PURE__ */ React30.createElement(
        ...
        hasTransactions
          ? visibleTxs.map((tx) =>
              /* @__PURE__ */ React30.createElement(TxItem, {
                key: tx.hash,
                tx,
              })
            )
    ...
    explorerLink &&
      /* @__PURE__ */ React30.createElement(
        ...
        /* @__PURE__ */ React30.createElement(
          ...
          /* @__PURE__ */ React30.createElement(ExternalLinkIcon, null)
        )
      )
  );
}
      ...
      /* @__PURE__ */ React32.createElement(
        ...
        /* @__PURE__ */ React32.createElement(
          ...
          /* @__PURE__ */ React32.createElement(ProfileDetailsAction, {
            ...
            icon: copiedAddress
              ? /* @__PURE__ */ React32.createElement(CopiedIcon, null)
              : /* @__PURE__ */ React32.createElement(CopyIcon, null),
      ...
      showRecentTransactions &&
        /* @__PURE__ */ React32.createElement(
          ...
          /* @__PURE__ */ React32.createElement(
            Box,
            null,
            /* @__PURE__ */ React32.createElement(TxList, {
              address,
            })
          )
        )
...
import {
  useAccount as useAccount10,
  useDisconnect as useDisconnect3,
  useNetwork as useNetwork5,
  useSwitchNetwork,
} from "wagmi";

// src/components/Icons/DisconnectSq.tsx
import React34 from "react";
var DisconnectSqIcon = ({ size }) =>
...
var MenuButton = React35.forwardRef(
  (
    { children, currentlySelected = false, onClick, testId, ...urlProps },
    ref
  ) => {
    const mobile = isMobile();
...
function ChainModal({ onClose, open }) {
  ...
  const unsupportedChain =
    (_a = activeChain == null ? void 0 : activeChain.unsupported) != null
      ? _a
      : false;
  ...
  useEffect12(() => {
    ...
    let provider;
    (_a2 = activeConnector == null ? void 0 : activeConnector.getProvider) ==
    null
      ? void 0
      : _a2.call(activeConnector).then((provider_) => {
          provider = provider_;
    ...
    return () => {
      provider == null
        ? void 0
        : provider.removeListener("chainChanged", stopSwitching2);
    };
          ...
          switchNetwork
            ? chains.map((chain, idx) => {
                const isCurrentChain =
                  chain.id === (activeChain == null ? void 0 : activeChain.id);
                ...
                const chainIconUrl =
                  rainbowKitChain == null ? void 0 : rainbowKitChain.iconUrl;
                const chainIconBackground =
                  rainbowKitChain == null
                    ? void 0
                    : rainbowKitChain.iconBackground;
                return /* @__PURE__ */ React36.createElement(
                  Fragment,
                  {
                    key: chain.id,
                  ...
                  mobile &&
                    idx < (chains == null ? void 0 : chains.length) - 1 &&
                    /* @__PURE__ */ React36.createElement(Box, {
                      background: "generalBorderDim",
                      height: "1",
                      marginX: "8",
      ...
      /* @__PURE__ */ React39.createElement(
        ...
        /* @__PURE__ */ React39.createElement(
          ...
          /* @__PURE__ */ React39.createElement(
            ...
            /* @__PURE__ */ React39.createElement(AssetsIcon, null)
          ),
          /* @__PURE__ */ React39.createElement(
            Box,
            {
        ...
        /* @__PURE__ */ React39.createElement(
          ...
          /* @__PURE__ */ React39.createElement(
            ...
            /* @__PURE__ */ React39.createElement(LoginIcon, null)
          ),
          /* @__PURE__ */ React39.createElement(
            Box,
            {
...
var CreateIcon = () =>
  /* @__PURE__ */ React44.createElement(AsyncImage, {
    background: "#e3a5e8",
...
var RefreshIcon = () =>
  /* @__PURE__ */ React45.createElement(AsyncImage, {
    background: "#515a70",
    borderColor: "generalBorder",
    borderRadius: "10",
    height: "48",
...
var ScanIcon = () =>
  /* @__PURE__ */ React46.createElement(AsyncImage, {
    background: "#515a70",
    borderColor: "generalBorder",
    borderRadius: "10",
    height: "48",
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc" /* Arc */:
      return (await import("./Arc-ZT5MU7SE.js")).default;
    case "Brave" /* Brave */:
    ...
    case "Opera" /* Opera */:
      return (await import("./Opera-6J2CQ7O6.js")).default;
    case "Safari" /* Safari */:
      return (await import("./Safari-HSMWXLX5.js")).default;
    default:
      return (await import("./Browser-MZYY2QO6.js")).default;
  }
};
var preloadBrowserIcon = () => loadImages(getBrowserSrc);
function GetDetail({ getWalletDownload }) {
        ...
        : shownWallets
            .filter((wallet) => {
              ...
              return (
                ...
                (wallet.qrCode &&
                  ((_a = wallet.downloadUrls) == null ? void 0 : _a.qrCode))
              );
            })
            .map((wallet) => {
              const {
              ...
              const hasMobileCompanionApp =
                (downloadUrls == null ? void 0 : downloadUrls.qrCode) && qrCode;
              const hasExtension = !!wallet.extensionDownloadUrl;
              const hasMobileAndExtension =
                (downloadUrls == null ? void 0 : downloadUrls.qrCode) &&
                hasExtension;
              return /* @__PURE__ */ React48.createElement(
                Box,
                {
...
function ConnectDetail({
  ...
  const hasQrCodeAndExtension =
    (downloadUrls == null ? void 0 : downloadUrls.qrCode) && hasExtension;
    ...
    /* @__PURE__ */ React48.createElement(
      ...
      extensionDownloadUrl &&
        /* @__PURE__ */ React48.createElement(DownloadOptionsBox, {
          ...
          onAction: () =>
            changeWalletStep(
              (extension == null ? void 0 : extension.instructions)
                ? "INSTRUCTIONS_EXTENSION" /* InstructionsExtension */
                : "CONNECT" /* Connect */
            ),
  ...
  return /* @__PURE__ */ React48.createElement(
    ...
    /* @__PURE__ */ React48.createElement(
      ...
      /* @__PURE__ */ React48.createElement(ActionButton, {
        ...
        onClick: () =>
          changeWalletStep(
            (qrCode == null ? void 0 : qrCode.instructions)
              ? "INSTRUCTIONS_MOBILE" /* InstructionsMobile */
              : "CONNECT" /* Connect */
          ),
      })
    )
...
function InstructionMobileDetail({ connectWallet, wallet }) {
  ...
  return /* @__PURE__ */ React48.createElement(
    ...
    /* @__PURE__ */ React48.createElement(
      ...
      (_b =
        (_a = wallet == null ? void 0 : wallet.qrCode) == null
          ? void 0
          : _a.instructions) == null
        ? void 0
        : _b.steps.map((d, idx) => {
            var _a2;
            return /* @__PURE__ */ React48.createElement(
              ...
              /* @__PURE__ */ React48.createElement(
                ...
                (_a2 = stepIcons[d.step]) == null
                  ? void 0
                  : _a2.call(stepIcons, wallet)
              ),
              /* @__PURE__ */ React48.createElement(
                Box,
                {
    ...
    /* @__PURE__ */ React48.createElement(
      ...
      /* @__PURE__ */ React48.createElement(
        Box,
        {
          ...
          href:
            (_d =
              (_c = wallet == null ? void 0 : wallet.qrCode) == null
                ? void 0
                : _c.instructions) == null
              ? void 0
              : _d.learnMoreUrl,
          paddingX: "12",
          paddingY: "4",
...
function InstructionExtensionDetail({ wallet }) {
  ...
  return /* @__PURE__ */ React48.createElement(
    ...
    /* @__PURE__ */ React48.createElement(
      ...
      (_b =
        (_a = wallet == null ? void 0 : wallet.extension) == null
          ? void 0
          : _a.instructions) == null
        ? void 0
        : _b.steps.map((d, idx) => {
    ...
    /* @__PURE__ */ React48.createElement(
      ...
      /* @__PURE__ */ React48.createElement(
        Box,
        {
          ...
          href:
            (_d =
              (_c = wallet == null ? void 0 : wallet.extension) == null
                ? void 0
                : _c.instructions) == null
              ? void 0
              : _d.learnMoreUrl,
...
function DesktopOptions({ onClose }) {
  ...
  const hasQrCode =
    !!(selectedWallet == null ? void 0 : selectedWallet.qrCode) && qrCodeUri;
  ...
  const connectToWallet = (wallet) => {
    ...
    if (wallet.ready) {
      (_b =
        (_a = wallet == null ? void 0 : wallet.connect) == null
          ? void 0
          : _a.call(wallet)) == null
        ? void 0
        : _b.catch(() => {
      ...
      const getDesktopDeepLink =
        (_c = wallet.desktop) == null ? void 0 : _c.getUri;
  ...
  const selectWallet = (wallet) => {
    ...
    if (wallet.ready) {
      ...
      (_a = wallet == null ? void 0 : wallet.onConnecting) == null
        ? void 0
        : _a.call(wallet, async () => {
            var _a2, _b;
            if (callbackFired) return;
            callbackFired = true;
            const sWallet = wallets.find((w) => wallet.id === w.id);
            const uri = await ((_a2 =
              sWallet == null ? void 0 : sWallet.qrCode) == null
              ? void 0
              : _a2.getUri());
            setQrCodeUri(uri);
            setTimeout(
            ...
            const provider = await (sWallet == null
              ? void 0
              : sWallet.connector.getProvider());
            const connection =
              (_b = provider == null ? void 0 : provider.signer) == null
                ? void 0
                : _b.connection;
            if (
              (connection == null ? void 0 : connection.on) &&
              (connection == null ? void 0 : connection.off)
            ) {
      ...
      changeWalletStep(
        (wallet == null ? void 0 : wallet.extensionDownloadUrl)
          ? "DOWNLOAD_OPTIONS" /* DownloadOptions */
          : "CONNECT" /* Connect */
      );
    }
  ...
  const getWalletDownload = (id) => {
    ...
    const isMobile2 =
      (_a = sWallet == null ? void 0 : sWallet.downloadUrls) == null
        ? void 0
        : _a.qrCode;
    const isExtension = !!(sWallet == null
      ? void 0
      : sWallet.extensionDownloadUrl);
    setSelectedWallet(sWallet);
  ...
  const changeWalletStep = (newWalletStep, isBack = false) => {
    if (
      isBack &&
      newWalletStep === "GET" /* Get */ &&
      initialWalletStep === "GET" /* Get */
    ) {
      clearSelectedWallet();
  ...
  const hasExtension = !!(selectedWallet == null
    ? void 0
    : selectedWallet.extensionDownloadUrl);
  const hasExtensionAndMobile = !!(
    hasExtension &&
    (selectedWallet == null ? void 0 : selectedWallet.mobileDownloadUrl)
  );
  switch (walletStep) {
    case "NONE" /* None */:
    ...
    case "GET" /* Get */:
      ...
      headerBackButtonLink = compactModeEnabled
        ? "LEARN_COMPACT" /* LearnCompact */
        : "NONE" /* None */;
      break;
    case "CONNECT" /* Connect */:
      walletContent =
        selectedWallet &&
        /* @__PURE__ */ React49.createElement(ConnectDetail, {
          changeWalletStep,
          compactModeEnabled,
          connectionError,
          onClose,
    ...
    case "DOWNLOAD_OPTIONS" /* DownloadOptions */:
      walletContent =
        selectedWallet &&
        /* @__PURE__ */ React49.createElement(DownloadOptionsDetail, {
          changeWalletStep,
          wallet: selectedWallet,
        });
      headerLabel = selectedWallet && `Get ${selectedWallet.name}`;
      headerBackButtonLink =
        hasExtensionAndMobile && "CONNECT" /* Connect */
          ? initialWalletStep
          : null;
      break;
    case "DOWNLOAD" /* Download */:
      walletContent =
        selectedWallet &&
        /* @__PURE__ */ React49.createElement(DownloadDetail, {
          changeWalletStep,
          wallet: selectedWallet,
        });
    ...
    case "INSTRUCTIONS_MOBILE" /* InstructionsMobile */:
      walletContent =
        selectedWallet &&
        /* @__PURE__ */ React49.createElement(InstructionMobileDetail, {
    ...
    case "INSTRUCTIONS_EXTENSION" /* InstructionsExtension */:
      walletContent =
        selectedWallet &&
        /* @__PURE__ */ React49.createElement(InstructionExtensionDetail, {
          wallet: selectedWallet,
        });
      headerLabel =
        selectedWallet &&
  ...
  return /* @__PURE__ */ React49.createElement(
    ...
    (compactModeEnabled ? walletStep === "NONE" /* None */ : true) &&
          ...
          compactModeEnabled &&
            ...
            /* @__PURE__ */ React49.createElement(
              ...
              /* @__PURE__ */ React49.createElement(InfoButton, {
                onClick: () =>
                  changeWalletStep("LEARN_COMPACT" /* LearnCompact */),
              })
            ),
          compactModeEnabled &&
            !Disclaimer &&
            ...
            /* @__PURE__ */ React49.createElement(
              ...
              headerBackButtonLink &&
                /* @__PURE__ */ React49.createElement(
                  ...
                  /* @__PURE__ */ React49.createElement(BackIcon, null)
                )
            ),
            /* @__PURE__ */ React49.createElement(
              Box,
...
// src/components/ConnectOptions/MobileOptions.tsx
function WalletButton({ onClose, wallet }) {
  const {
    connect,
    connector,
    iconBackground,
  ...
  return /* @__PURE__ */ React50.createElement(
    Box,
    {
      ...
      onClick: useCallback8(async () => {
        if (id === "walletConnect") onClose == null ? void 0 : onClose();
...
function MobileOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "CONNECT" /* Connect */: {
      ...
      walletContent = /* @__PURE__ */ React50.createElement(
        Box,
        null,
        /* @__PURE__ */ React50.createElement(
          Box,
        ...
        (_a =
          wallets == null
            ...
            : wallets.filter((wallet) => {
                var _a2, _b, _c;
                return (
                  ((_a2 = wallet.downloadUrls) == null ? void 0 : _a2.ios) ||
                  ((_b = wallet.downloadUrls) == null ? void 0 : _b.android) ||
                  ((_c = wallet.downloadUrls) == null ? void 0 : _c.mobile)
                );
              })) == null
          ? void 0
          : _a.splice(0, 3);
      walletContent = /* @__PURE__ */ React50.createElement(
        ...
        /* @__PURE__ */ React50.createElement(
          ...
          mobileWallets.map((wallet, index) => {
            ...
            if (
              !(downloadUrls == null ? void 0 : downloadUrls.ios) &&
              !(downloadUrls == null ? void 0 : downloadUrls.android) &&
              !(downloadUrls == null ? void 0 : downloadUrls.mobile)
            ) {
              return null;
            }
            return /* @__PURE__ */ React50.createElement(
  ...
  return /* @__PURE__ */ React50.createElement(
    ...
    /* @__PURE__ */ React50.createElement(
      Box,
      {
        background: headerBackgroundContrast
          ? "profileForeground"
          : "modalBackground",
        display: "flex",
        flexDirection: "column",
        ...
        headerBackButtonLink &&
          /* @__PURE__ */ React50.createElement(
            ...
            /* @__PURE__ */ React50.createElement(
              ...
              /* @__PURE__ */ React50.createElement(BackIcon, null)
            )
          ),
        /* @__PURE__ */ React50.createElement(
          Box,
...
function ConnectOptions({ onClose }) {
  return isMobile()
    ? /* @__PURE__ */ React51.createElement(MobileOptions, {
        onClose,
      })
...
function ModalProvider({ children }) {
  ...
  return /* @__PURE__ */ React53.createElement(
        ...
        () => ({
          ...
          openAccountModal:
            chainSupported && connectionStatus === "connected"
              ...
              : void 0,
          openChainModal:
            connectionStatus === "connected" ? openChainModal : void 0,
          openConnectModal:
    ...
    children,
    /* @__PURE__ */ React53.createElement(ConnectModal, {
...
function ConnectButtonRenderer({ children }) {
  ...
  const authenticationStatus =
    (_a = useAuthenticationStatus()) != null ? _a : void 0;
  const rainbowKitChain = activeChain
    ? rainbowkitChainsById[activeChain.id]
    : void 0;
  const chainIconUrl =
    (_b = rainbowKitChain == null ? void 0 : rainbowKitChain.iconUrl) != null
      ? _b
      : void 0;
  const chainIconBackground =
    (_c = rainbowKitChain == null ? void 0 : rainbowKitChain.iconBackground) !=
    null
      ? _c
      : void 0;
    ...
    children({
      account: address
        ? {
            address,
            balanceDecimals:
              balanceData == null ? void 0 : balanceData.decimals,
            balanceFormatted:
              balanceData == null ? void 0 : balanceData.formatted,
...
function ConnectButton({
  ...
  return /* @__PURE__ */ React55.createElement(
    ...
    ({
      ...
      const unsupportedChain =
        (_a = chain == null ? void 0 : chain.unsupported) != null ? _a : false;
      return /* @__PURE__ */ React55.createElement(
        Box,
        {
          display: "flex",
                  ...
                  unsupportedChain
                    ...
                    : /* @__PURE__ */ React55.createElement(
                        ...
                        /* @__PURE__ */ React55.createElement(
                          ...
                          (_c = chain.name) != null ? _c : chain.id
                        )
                      ),
                  /* @__PURE__ */ React55.createElement(DropdownIcon, null)
                ),
              !unsupportedChain &&
                /* @__PURE__ */ React55.createElement(
                  Box,
                  ...
                  /* @__PURE__ */ React55.createElement(
                    Box,
                    {
                      background: normalizeResponsiveValue(showBalance)[
