...
var _RecognitionManager = _interopRequireDefault(
  require("./RecognitionManager")
);

var _isAndroid = _interopRequireDefault(require("./isAndroid"));

var _NativeSpeechRecognition = _interopRequireDefault(
  require("./NativeSpeechRecognition")
);
...
var _browserSupportsContinuousListening =
  _browserSupportsSpeechRecognition && !(0, _isAndroid["default"])();
...
var useSpeechRecognition = function useSpeechRecognition() {
  var _ref =
    ...
    clearTranscriptOnListen =
      _ref$clearTranscriptO === void 0 ? true : _ref$clearTranscriptO,
  ...
  var resetTranscript = (0, _react.useCallback)(
    function () {
  ...
  var testFuzzyMatch = function testFuzzyMatch(
    command,
    input,
    fuzzyMatchingThreshold
  ) {
    var commandToString =
      _typeof(command) === "object" ? command.toString() : command;
    var commandWithoutSpecials = commandToString
      .replace(/[&/\\#,+()!$~%.'":*?<>{}]/g, "")
      .replace(/  +/g, " ")
      .trim();
    var howSimilar = (0, _utils.compareTwoStringsUsingDiceCoefficient)(
  ...
  var matchCommands = (0, _react.useCallback)(
    function (newInterimTranscript, newFinalTranscript) {
      commandsRef.current.forEach(function (_ref2) {
        var command = _ref2.command,
          callback = _ref2.callback,
          _ref2$matchInterim = _ref2.matchInterim,
          matchInterim =
            _ref2$matchInterim === void 0 ? false : _ref2$matchInterim,
          _ref2$isFuzzyMatch = _ref2.isFuzzyMatch,
          isFuzzyMatch =
            _ref2$isFuzzyMatch === void 0 ? false : _ref2$isFuzzyMatch,
          _ref2$fuzzyMatchingTh = _ref2.fuzzyMatchingThreshold,
          fuzzyMatchingThreshold =
            _ref2$fuzzyMatchingTh === void 0 ? 0.8 : _ref2$fuzzyMatchingTh,
        ...
        if (isFuzzyMatch && bestMatchOnly && results.length >= 2) {
          ...
          results.forEach(function (result) {
            if (result.isFuzzyMatch) {
              ...
              callback.apply(
                void 0,
                _toConsumableArray(parameters).concat([
                  {
                    command: _command3,
                    resetTranscript: resetTranscript,
                  },
  ...
  var handleTranscriptChange = (0, _react.useCallback)(
    function (newInterimTranscript, newFinalTranscript) {
      if (transcribing) {
        dispatch(
          (0, _actions.appendTranscript)(
  ...
  var handleClearTranscript = (0, _react.useCallback)(
    function () {
  ...
  var transcript = (0, _utils.concatTranscripts)(
    finalTranscript,
    interimTranscript
  );
  return {
...
var SpeechRecognition = {
  ...
  applyPolyfill: function applyPolyfill(PolyfillSpeechRecognition) {
    if (recognitionManager) {
      ...
      recognitionManager = new _RecognitionManager["default"](
        PolyfillSpeechRecognition
      );
    }

    var browserSupportsPolyfill =
      !!PolyfillSpeechRecognition && (0, _utils.browserSupportsPolyfills)();
  ...
  removePolyfill: function removePolyfill() {
    if (recognitionManager) {
      recognitionManager.setSpeechRecognition(
        _NativeSpeechRecognition["default"]
      );
    } else {
      recognitionManager = new _RecognitionManager["default"](
        _NativeSpeechRecognition["default"]
  ...
  startListening: (function () {
    var _startListening = _asyncToGenerator(
  ...
  stopListening: (function () {
    var _stopListening = _asyncToGenerator(
  ...
  abortListening: (function () {
    var _abortListening = _asyncToGenerator(
  ...
  browserSupportsContinuousListening:
    function browserSupportsContinuousListening() {
