...
var RecognitionManager = /*#__PURE__*/ (function () {
  function RecognitionManager(SpeechRecognition) {
    ...
    if ((0, _isAndroid["default"])()) {
      this.updateFinalTranscript = (0, _utils.debounce)(
  ...
  _createClass(RecognitionManager, [
    {
      ...
      value: function setSpeechRecognition(SpeechRecognition) {
        var browserSupportsRecogniser =
          !!SpeechRecognition &&
          ((0, _NativeSpeechRecognition.isNative)(SpeechRecognition) ||
            (0, _utils.browserSupportsPolyfills)());
        ...
        this.emitBrowserSupportsSpeechRecognitionChange(
    ...
    },
    {
      ...
      value: function emitMicrophoneAvailabilityChange(isMicrophoneAvailable) {
        ...
        Object.keys(this.subscribers).forEach(function (id) {
          var onMicrophoneAvailabilityChange =
            _this2.subscribers[id].onMicrophoneAvailabilityChange;
    ...
    },
    {
      ...
      value: function emitBrowserSupportsSpeechRecognitionChange(
        ...
        Object.keys(this.subscribers).forEach(function (id) {
          var _this5$subscribers$id = _this5.subscribers[id],
            onBrowserSupportsSpeechRecognitionChange =
              _this5$subscribers$id.onBrowserSupportsSpeechRecognitionChange,
            onBrowserSupportsContinuousListeningChange =
              _this5$subscribers$id.onBrowserSupportsContinuousListeningChange;
          onBrowserSupportsSpeechRecognitionChange(
            browserSupportsSpeechRecognitionChange
          );
          onBrowserSupportsContinuousListeningChange(
    ...
    },
    {
      ...
      value: function updateTranscript(_ref) {
        ...
        for (var i = currentIndex; i < results.length; ++i) {
          if (
            results[i].isFinal &&
            (!(0, _isAndroid["default"])() || results[i][0].confidence > 0)
          ) {
            this.updateFinalTranscript(results[i][0].transcript);
          } else {
            this.interimTranscript = (0, _utils.concatTranscripts)(
              this.interimTranscript,
    ...
    },
    {
      ...
      value: function updateFinalTranscript(newFinalTranscript) {
        this.finalTranscript = (0, _utils.concatTranscripts)(
          this.finalTranscript,
          newFinalTranscript
        );
      },
                  ...
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      (_ref2 =
                        _args.length > 0 && _args[0] !== undefined
                          ? _args[0]
                          : {}),
                        (_ref2$continuous = _ref2.continuous),
                        (continuous =
                          _ref2$continuous === void 0
                            ? false
                            : _ref2$continuous),
                    ...
                    case 3:
                      isContinuousChanged =
                        continuous !== this.recognition.continuous;
                      isLanguageChanged =
                        language && language !== this.recognition.lang;
