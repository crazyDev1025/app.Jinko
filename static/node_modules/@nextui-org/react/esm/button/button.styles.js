...
import { cssFocusVisible as o } from "../theme/shared-css";
import { StyledDrip as i } from "../utils/drip";
export const StyledButton = r(
  "button",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        css: {
          ...
          color: "$error",
          [`& ${i}`]: {
            ".nextui-drip-filler": { opacity: 0.8, fill: "$errorLightActive" },
          },
        },
      },
      {
        ...
        css: {
          ...
          borderColor: "$primary",
          color: "$primary",
          [`& ${i}`]: { ".nextui-drip-filler": { fill: "$primary" } },
        },
      },
      {
        bordered: !0,
      ...
      },
      {
        ...
        css: {
          ...
          color: "$secondary",
          [`& ${i}`]: { ".nextui-drip-filler": { fill: "$secondary" } },
        },
      },
      {
        bordered: !0,
        ...
        css: {
          ...
          borderColor: "$success",
          color: "$success",
          [`& ${i}`]: { ".nextui-drip-filler": { fill: "$success" } },
        },
      },
      {
        bordered: !0,
        ...
        css: {
          ...
          borderColor: "$warning",
          color: "$warning",
          [`& ${i}`]: { ".nextui-drip-filler": { fill: "$warning" } },
        },
      },
      {
        bordered: !0,
        ...
        css: {
          ...
          borderColor: "$error",
          color: "$error",
          [`& ${i}`]: { ".nextui-drip-filler": { fill: "$error" } },
        },
      },
      {
        bordered: !0,
