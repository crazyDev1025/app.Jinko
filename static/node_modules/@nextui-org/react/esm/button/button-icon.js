...
export const StyledButtonIcon = i("span", {
  dflex: "center",
  position: "absolute",
  left: "$$buttonPadding",
  right: "auto",
...
const e = ({ children: t, className: i, css: n, ...e }) =>
  o(StyledButtonIcon, {
    className: s(
      "nextui-button-icon",
      {
        "nextui-button-icon-right": e.isRight,
        "nextui-button-icon-single": e.isSingle,
      },
      i
    ),
    css: n,
