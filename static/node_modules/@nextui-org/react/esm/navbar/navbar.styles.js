import { styled as r } from "../theme/stitches.config";
import { cssFocusVisible as a, cssHideShowIn as t } from "../theme/shared-css";
const o = {
  default: {
...
export const StyledBaseNavbarItem = r("li", {
  mb: 0,
  display: "flex",
  alignItems: "center",
  listStyleType: "none",
...
export const StyledBaseNavbarList = r("ul", {
  m: 0,
  listStyle: "none",
  lineHeight: "$xs",
  li: { mb: 0 },
});
export const StyledNavbarCollapseItem = r(StyledBaseNavbarItem, {
  opacity: 0,
  paddingBottom: "$6",
  fontSize: "$lg",
  lineHeight: "$lg",
  ...
  variants: {
    activeColor: o,
    isActive: {
      true: { color: "$$navbarItemActiveColor", fontWeight: "$semibold" },
    },
    disableAnimation: { true: { transition: "none" } },
  },
  defaultVariants: { activeColor: "default" },
});
export const StyledNavbarCollapseWrapper = r(StyledBaseNavbarList, {
  py: "$8",
  px: "$$navbarPadding",
  overflowY: "scroll",
  maxHeight: "100%",
});
export const StyledNavbarCollapse = r(
  "div",
  {
    ...
    variants: {
      isOpen: {
        true: { top: "$$navbarHeight", pb: "$$navbarHeight", height: "100vh" },
      },
      disableBlur: {
        false: {
      ...
      disableAnimation: {
        true: { [`& ${StyledNavbarCollapseItem}`]: { transition: "none" } },
      },
    },
    defaultVariants: { disableBlur: "false" },
  },
  t
);
export const StyledNavbarToggleIconContainer = r("div", {
  dflex: "center",
  ...
  "& .line": {
    ...
    "&.top": { transform: "translateY(-4px) rotate(0deg)" },
    "&.bottom": { transform: "translateY(4px) rotate(0deg)" },
  },
  variants: {
    isExpanded: {
      true: {
        "& .line": {
          "&.top": { transform: "translateY(1px) rotate(45deg)" },
          "&.bottom": { transform: "translateY(0px) rotate(-45deg)" },
        },
      },
    },
  },
});
export const StyledNavbarToggle = r(
  "button",
  {
    appearance: "none",
    ...
    variants: { isPressed: { true: { opacity: 0.7 } } },
  },
  t,
  a
);
export const StyledNavbarBrand = r(
  "span",
  {
    display: "flex",
    flexWrap: "nowrap",
...
export const StyledNavbarItem = r(
  StyledBaseNavbarItem,
  {
    ...
    ":first-child": { boxSizing: "content-box" },
    "&:before": {
      opacity: 0,
      zIndex: "$1",
      content: '""',
    ...
    variants: {
      ...
      variant: {
        default: {},
        underline: { color: "inherit", height: "100%" },
        "underline-rounded": { color: "inherit", height: "100%" },
        highlight: {},
        "highlight-solid": {},
        "highlight-rounded": {},
      ...
      underlineHeight: {
        light: { $$navbarItemUnderlineHeight: "2px" },
        normal: { $$navbarItemUnderlineHeight: "4px" },
        bold: { $$navbarItemUnderlineHeight: "6px" },
        extrabold: { $$navbarItemUnderlineHeight: "8px" },
        black: { $$navbarItemUnderlineHeight: "10px" },
      },
      isDisabled: { true: { opacity: 0.5, cursor: "not-allowed" } },
    },
    compoundVariants: [
      {
        isActive: !0,
        variant: "underline",
        css: { color: "inherit", "&:after": { opacity: 1 } },
      },
      {
        isActive: !0,
...
export const StyledCursorHighlight = r(StyledBaseNavbarItem, {
  position: "absolute",
  ...
  borderRadius: "$sm",
  transition:
    "width 0.2s ease 0s, transform 0.2s ease 0s, opacity 0.2s ease 0s",
  variants: {
    color: o,
    isHighlightVariant: {
      true: { background: "$$navbarItemHighlightBackgroundColor" },
    },
    isHighlightSolidVariant: {
      true: { background: "$$navbarItemHighlightSolidBackgroundColor" },
    },
    isRounded: { true: { borderRadius: "$pill" } },
  },
});
export const StyledNavbarContent = r(
  StyledBaseNavbarList,
  {
    ...
    color: "inherit",
    variants: {
      enableCursorHighlight: { true: { zIndex: "$2", position: "relative" } },
    },
  },
  t
);
export const StyledNavbarContainer = r("div", {
  width: "100%",
  height: "$$navbarHeight",
  ...
  zIndex: "$5",
  "@xsMax": { $$navbarPadding: "$space$6", $$navbarFloatingMargin: "$space$6" },
});
export const StyledNavbar = r("nav", {
  width: "100%",
  dflex: "center",
  position: "relative",
  height: "auto",
  ...
  variants: {
    variant: {
      ...
      sticky: { top: 0, right: 0, left: 0, position: "sticky" },
      floating: {
        top: 0,
        right: 0,
        left: 0,
    ...
    maxWidth: {
      xs: { $$navbarContainerMaxWidth: "$breakpoints$xs" },
      sm: { $$navbarContainerMaxWidth: "$breakpoints$sm" },
      md: { $$navbarContainerMaxWidth: "$breakpoints$md" },
      lg: { $$navbarContainerMaxWidth: "$breakpoints$lg" },
      xl: { $$navbarContainerMaxWidth: "$breakpoints$xl" },
      fluid: { $$navbarContainerMaxWidth: "100%" },
    },
    isBordered: {
      true: {
        [`& ${StyledNavbarContainer}`]: {
    ...
    disableShadow: { false: { boxShadow: "$$navbarShadow" } },
    disableBlur: {
      false: {
        "@supports ((-webkit-backdrop-filter: none) or (backdrop-filter: none))":
          {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      css: {
        boxShadow: "none",
        [`& ${StyledNavbarContainer}`]: { boxShadow: "$$navbarShadow" },
      },
    },
  ],
  defaultVariants: {
