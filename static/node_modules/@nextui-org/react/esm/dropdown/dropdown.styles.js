import { styled as o } from "../theme/stitches.config";
import { cssFocusVisible as r } from "../theme/shared-css";
export const StyledDropdownMenu = o("ul", {
...
export const StyledDropdownItemIconWrapper = o("span", {
  dflex: "center",
  flexShrink: 0,
  mr: "$4",
});
export const StyledDropdownItemKbd = o("kbd", {
  opacity: 0.8,
  ml: "$4",
  mr: 0,
  dflex: "center",
...
export const StyledDropdownItemContentWrapper = o("div", {
  d: "flex",
  flex: "1 1 0%",
...
export const StyledDropdownItemContent = o("span", { flex: "1 1 0%" });
export const StyledDropdownItemDescription = o("span", {
  fontSize: "$xs",
  color: "$$dropdownItemDescriptionColor",
  truncateText: "calc($$dropdownMenuWidth * 0.9)",
  transition: "color 0.12s ease 0s",
  variants: {
    hasIcon: { true: { truncateText: "calc($$dropdownMenuWidth * 0.7)" } },
  ...
  compoundVariants: [
    {
      hasIcon: !0,
      hasCommand: !0,
      css: { truncateText: "calc($$dropdownMenuWidth * 0.6)" },
    },
  ],
});
export const StyledDropdownItem = o(
  "li",
  {
    ...
    "@motion": {
      transition: "none",
      [`& ${StyledDropdownItemKbd}`]: { transition: "none" },
      [`& ${StyledDropdownItemDescription}`]: { transition: "none" },
    },
    variants: {
      color: {
        default: {
      ...
      isPressed: { true: { bg: "$$dropdownItemActiveBackground" } },
      isFocused: {
        true: {
          ...
          [`& ${StyledDropdownItemDescription}`]: { color: "currentColor" },
        },
      },
      isHovered: {
        true: {
      ...
      isSelected: { true: {} },
      isSelectable: { true: {} },
      isDisabled: { true: { color: "$accents5", cursor: "default" } },
      withDescription: { true: { height: "calc($$dropdownItemHeight * 1.2)" } },
      withDivider: {
        true: {
          mt: "$6",
          "&:before": {
      ...
      dividerWeight: {
        light: { $$dropdownItemBorderWeight: "$borderWeights$light" },
        normal: { $$dropdownItemBorderWeight: "$borderWeights$normal" },
        bold: { $$dropdownItemBorderWeight: "$borderWeights$bold" },
        extrabold: { $$dropdownItemBorderWeight: "$borderWeights$extrabold" },
        black: { $$dropdownItemBorderWeight: "$borderWeights$black" },
      },
      showFullDescription: {
        true: {
    ...
    compoundVariants: [
      {
        isPressed: !0,
        disableAnimation: !1,
        css: { transform: "scale($$dropdownItemPressedScale)" },
      },
      { isHovered: !0, variant: "light", css: { bg: "transparent" } },
      { isFocused: !0, variant: "light", css: { bg: "transparent" } },
      {
        isHovered: !0,
        variant: "solid",
        css: {
      ...
      },
      {
        variant: "flat",
        color: "default",
        css: { $$dropdownItemHoverTextColor: "$colors$foreground" },
      },
    ],
    defaultVariants: {
      color: "default",
...
export const StyledDropdownSectionWrapper = o("li", { mb: 0 });
export const StyledDropdownSection = o("ul", { m: 0, p: 0, listStyle: "none" });
export const StyledDropdownSectionTitle = o("span", {
  fontWeight: "$medium",
  fontSize: "$xs",
  padding: "0 $4",
  color: "$accents8",
