...
import {
  StyledDropdownItem as m,
  StyledDropdownItemKbd as u,
  StyledDropdownItemContent as h,
  StyledDropdownItemIconWrapper as f,
  StyledDropdownItemContentWrapper as w,
  StyledDropdownItemDescription as x,
...
const D = ({
  ...
  const {
    ...
    G = o(null),
    { pressProps: J, isPressed: L } = a({ ref: G, isDisabled: E }),
    { isFocusVisible: Q, focusProps: R } = r({ autoFocus: k }),
    { hoverProps: T, isHovered: X } = t({ isDisabled: E }),
    Y = "none" !== N.selectionManager.selectionMode && !E,
    {
      menuItemProps: Z,
      labelProps: _,
      descriptionProps: ee,
      keyboardShortcutProps: oe,
    } = d(
      {
        key: $,
        onClose: O,
    ...
    ie = s(
      () =>
        D.props.textColor
          ? D.props.textColor
          : D.props.color && "default" === C
          ? D.props.color
          : C,
      [C, D.props.color, D.props.textColor]
    ),
    re = s(() => g || D.props.description, [g, D.props.description]),
    te = s(() => S || D.props.command, [S, D.props.command]),
    ae = s(() => P || D.props.icon, [P, D.props.icon]);
  return v(m, {
    ref: G,
    ...i(Z, T, J, R),
    as: D.props.as || e,
    ...
    children: [
      ae &&
        b(f, { className: "nextui-dropdown-item-icon-wrapper", children: ae }),
      re
        ? v(w, {
            children: [
              b(h, {
...
p && (D.displayName = "NextUI.DropdownItem"),
