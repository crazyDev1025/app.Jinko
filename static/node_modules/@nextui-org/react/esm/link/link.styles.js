...
export const StyledLinkIcon = o("svg", {
  ml: "$1",
  as: "center",
  display: "flex",
  color: "currentColor",
});
export const StyledLink = o(
  "a",
  {
    ...
    variants: {
      ...
      underline: {
        true: { "&:hover, &:active, &:focus": { textDecoration: "underline" } },
      },
      block: {
        true: {
          padding: "$2 $4",
      ...
      animated: {
        true: { transition: "opacity 0.25s ease 0s, box-shadow 0.25s ease 0s" },
      },
    },
    compoundVariants: [
      {
