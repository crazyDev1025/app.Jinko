...
tuple("default", "slient", "prevent"),
  ...
  tuple("flex-start", "flex-end", "center", "stretch", "baseline"),
  tuple(
    "stretch",
    "center",
    "flex-start",
  ...
  tuple("row", "row-reverse", "column", "column-reverse"),
  tuple("nowrap", "wrap", "wrap-reverse"),
  tuple(
    "flex",
    "block",
    "grid",
...
tuple("toggle", "replace"),
  tuple("none", "single", "multiple"),
  tuple("flat", "light", "solid", "shadow"),
  tuple("flat", "bordered", "shadow");
