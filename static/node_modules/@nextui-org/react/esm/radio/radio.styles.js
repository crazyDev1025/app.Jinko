...
export const StyledRadioText = o("span", {
  fontSize: "$$radioSize",
  us: "none",
  d: "inline-flex",
  ai: "center",
...
export const StyledRadioPoint = o(
  "span",
  {
    size: "$$radioSize",
    br: "$$radioRadii",
...
export const StyledRadioLabel = o("label", {
  d: "flex",
  w: "initial",
  ai: "flex-start",
  position: "relative",
  ...
  variants: {
    ...
    isChecked: {
      true: {
        [`& ${StyledRadioPoint}`]: {
          "&:after": { border: "calc($$radioSize * 0.34) solid $$radioColor" },
        },
      },
    },
    disableAnimation: {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      isDisabled: !1,
      isHovered: !0,
      css: { [`& ${StyledRadioPoint}`]: { bg: "$border" } },
    },
  ],
});
export const StyledRadioDescription = o("span", {
  color: "$accents7",
...
export const StyledRadioContainer = o("div", {
  w: "initial",
  position: "relative",
  d: "flex",
  fd: "row",
...
export const StyledRadioGroupLabel = o("label", {
  d: "block",
  fontWeight: "$normal",
...
export const StyledRadioGroup = o("div", {
  border: 0,
  margin: 0,
  padding: 0,
  display: "flex",
...
export const StyledRadioGroupContainer = o("div", {
  display: "flex",
  ...
  variants: {
    isRow: {
      true: {
        mt: 0,
        flexDirection: "row",
        [`& ${StyledRadioLabel}:not(:last-child)`]: { mr: "$$radioSize" },
      },
      false: {
        mr: 0,
        flexDirection: "column",
        [`& ${StyledRadioLabel}:not(:first-child)`]: { mt: "$$radioSize" },
      },
    },
  },
