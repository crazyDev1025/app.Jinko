import { keyframes as o, styled as t } from "../theme/stitches.config";
const i = o({
  "0%": { backgroundPosition: "200% 0" },
  to: { backgroundPosition: "-200% 0" },
});
export const StyledImageContainer = t("div", {
  opacity: 0,
  margin: "0 auto",
  position: "relative",
  overflow: "hidden",
...
export const StyledImage = t("img", { size: "100%", display: "block" });
export const StyledImageSkeleton = t("div", {
  position: "absolute",
  top: 0,
  left: 0,
  right: 0,
