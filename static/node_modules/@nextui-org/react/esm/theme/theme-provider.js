import e, { useState as t, useMemo as r, useEffect as o } from "react";
...
import a from "../utils/deep-merge";
import { copyObject as n } from "../utils/object";
import u from "../use-ssr";
import {
  changeTheme as d,
  getThemeName as c,
  getDocumentCSSTokens as p,
  getDocumentTheme as v,
} from "./utils";
import f, { defaultContext as b } from "./theme-context";
import { jsx as h } from "react/jsx-runtime";
import { jsxs as y } from "react/jsx-runtime";
export default l(
  ({ theme: e, disableBaseline: l, children: x }) => {
    const { isBrowser: j } = u(),
      [B, N] = t(b.type),
      g = (e) => {
        N((t) => (t !== e ? e : t));
    ...
    return (
      o(() => {
        ...
        return (
          o.observe(null == (t = document) ? void 0 : t.documentElement, {
            attributes: !0,
      ...
      o(() => {
        j &&
          ...
          null != e &&
          e.className &&
          (d(e.className), g(c(e.className)));
      }, [j, e]),
      h(m, {
        children: h(s, {
          children: y(f.Provider, { value: E, children: [!l && h(i, {}), x] }),
        }),
      })
    );
  },
