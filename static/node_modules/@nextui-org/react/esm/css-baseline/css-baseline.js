import e from "react";
import { globalCss as t, getCssText as o } from "../theme/stitches.config";
...
const n = t({
  ...
  r = ({ children: t }) => (n(), i(e.Fragment, { children: t })),
  l = e.memo(r);
l.flush = () =>
  i("style", { dangerouslySetInnerHTML: { __html: o() }, id: "stitches" });
export default l;
