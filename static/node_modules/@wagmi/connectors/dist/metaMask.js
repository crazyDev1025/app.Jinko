import { InjectedConnector } from "./chunk-2VZS2JHJ.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
var MetaMaskConnector = class extends InjectedConnector {
  constructor({ chains, options: options_ } = {}) {
    ...
    __privateSet(
      this,
      _UNSTABLE_shimOnConnectSelectAccount,
  ...
  async connect({ chainId } = {}) {
    try {
      ...
      let account = null;
      if (
        __privateGet(this, _UNSTABLE_shimOnConnectSelectAccount) &&
